...
tags:
  ...
  - "React"
  - "Data Visualization"
description: "A React web application that uses Three JS and statistics to visualize a global time-distance problem related to sea control."
...
<Pullquote>
  ...
  <GatsbyLink to="/global-speed-analysis-tool/">Speed Analysis Tool</GatsbyLink>
</Pullquote>
...
The code for the original data visualization is available in this Github repository: [Github repo](https://github.com/reggie3/Capstone-GetThereFirst)
...
<Pullquote>
  The updated visualization can be found here{" "}
  <GatsbyLink to="/global-speed-analysis-tool/">Speed Analysis Tool</GatsbyLink>
</Pullquote>
