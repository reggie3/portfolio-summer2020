...
The last commit to that repository was made over five years ago and uses the we technologies available at that time.  A quick dive into that code base reveals some jQuery, Bootstrap, and vanilla Three.js.
...
<Pullquote>
  The updated visualization can be found here <GatsbyLink to="/global-speed-analysis-tool/">
     Speed Analysis Tool
  </GatsbyLink>
</Pullquote>
