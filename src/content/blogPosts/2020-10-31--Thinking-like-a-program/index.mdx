...
There are lots of articles available on how to think like a programmer. A quick Google search of “how to think like a programmer” yields more than 95 million results:
...
This article is my attempt to fill that hole. It will explain why you might want to think like a program, and how you can do it. This article won’t cover design patters, or any advanced programming concepts. The primary audience is people who are beginning to learn how to code, commonly referred to as “Code Newbies” and are aware of concepts like variables, for loops, and if statements.
...
6. Then, once I got to the desired depth, I would stop digging
   Then I try to think in terms of the four skills I identified above.
